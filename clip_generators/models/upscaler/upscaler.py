...
sys.path.append(str(current_path / '../taming_transformers'))
sys.path.append(str(current_path / './latent_diffusion'))
...
def latent_upscale(image_path: str, output_path: str) -> str:
    diffusion_steps = 100
    ...
    logs = run(model["model"], image_path, diffMode, diffusion_steps, eta)
    sample = logs['sample']
